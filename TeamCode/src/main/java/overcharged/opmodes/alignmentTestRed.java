...
@Config
@TeleOp(name = "alignment test knuckles", group = "!!Teleop")
public class alignmentTestRed extends OpMode {
    RobotMecanum robot;
    ...
    public void init(){
        ...
        limelight.start();
        robot.turret.setUseSquID(true,0,0.5f);
    }
